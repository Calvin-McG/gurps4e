export class postureHelpers {
    ...
    static getPosture(tokenEffects) {
        ...
        if (typeof tokenEffects !== "undefined" && tokenEffects.length) { // If tokenEffects is defined and has a length
            for (let x = 0; x < tokenEffects.length; x++) { // Loop through and check postures.
