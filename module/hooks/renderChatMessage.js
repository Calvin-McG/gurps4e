  ...
  let activeDefenceModal = new Dialog({
    ...
    buttons: {
      dodge: {
        ...
        label: "Dodge",
        callback: (html) => {
          gatherOptions(html, "dodge", flags, locationIDs)
        }
      },
      block: {
        ...
        label: "Block",
        callback: (html) => {
          gatherOptions(html, "block", flags, locationIDs)
        }
      },
      parry: {
        ...
        label: "Parry",
        callback: (html) => {
          gatherOptions(html, "parry", flags, locationIDs)
        }
      }
    },
    default: "dodge",
...
function gatherOptions(html, type, flags, locationIDs){
  let selection;
  let name;
...
function rollActiveDefence(mod, selection, name, options, flags, locationIDs, type) {
  console.log(mod)
