...
export class gurpsActor extends Actor {
	...
	listAttacks(actor){
		...
		actor.items.forEach((item) => {
			if ((item.type == "Trait" || item.type == "Equipment" || item.type == "Spell" || item.type == "Custom Weapon" || item.type == "Custom Armour" || item.type == "Travel Fare" || (item.type == "Ritual" && item.system.quantity > 0)) && item.system.equipStatus === "equipped"){
